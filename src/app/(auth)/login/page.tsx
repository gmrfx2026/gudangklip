  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="hidden w-1/2 bg-gradient-to-br from-[#6c63ff] to-[#3b82f6] lg:flex lg:flex-col lg:justify-between lg:p-12">
        ...
        <div>
          <h2 className="mb-4 text-4xl font-bold text-white">Selamat Datang Kembali!</h2>
          <p className="text-lg text-white/80">
            Login ke akun kamu dan lanjutkan perjalanan sebagai creator atau brand di GudangKlip.
          </p>
        </div>
        <div className="grid grid-cols-3 gap-4">
          {[
            { value: "Rp 1M+", label: "Budget Bulanan" },
            { value: "300K+", label: "Creators Aktif" },
            { value: "3 Hari", label: "Payout" },
          ].map((s) => (
        ...
        <div className="w-full max-w-md">
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-[#0a0a1a] px-2 text-[#8888aa]">atau login dengan email</span>
            </div>
          </div>
