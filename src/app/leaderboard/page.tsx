      ...
      <main className="pt-24 pb-20">
        <div className="mx-auto max-w-3xl px-4">
          <div className="mb-8 text-center">
            ...
            <p className="text-[#b8b8d0]">Top creators bulan ini berdasarkan total earnings.</p>
          </div>
          ...
          {loading ? (
            ...
            <div className="py-20 text-center text-[#8888aa]">
              <p className="text-lg">Belum ada data creator.</p>
            </div>
          ) : (
                  ...
                  <div key={l.id} className={`rounded-2xl border p-4 ${rank <= 3 ? "border-[#6c63ff]/30 bg-[#6c63ff]/5" : "border-[#2a2a50] bg-[#111128]/50"}`}>
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-xs text-[#8888aa]">{formatCompactNumber(l.totalViews)} views</p>
                      </div>
                    </div>
                  </div>
                );
