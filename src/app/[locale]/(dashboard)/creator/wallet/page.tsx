    ...
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-[#2a2a50] bg-gradient-to-br from-[#6c63ff]/10 to-[#3b82f6]/10 p-6">
        ...
        <div className="flex gap-3">
          ...
          >
            <ArrowUpRight className="h-4 w-4" /> {t("CreatorWallet.withdraw")}
          </button>
          <button
          ...
          >
            <ArrowDownLeft className="h-4 w-4" /> {t("CreatorWallet.topUp")}
          </button>
        </div>
      </div>
      ...
      {showTopUp && (
        <div className="rounded-2xl border border-[#2a2a50] bg-[#111128]/50 p-6">
          <h3 className="mb-4 text-lg font-semibold text-white">{t("CreatorWallet.topUpTitle")}</h3>
          <form onSubmit={handleTopUp} className="space-y-4">
            <div>
              <label className="mb-1.5 block text-sm font-medium text-[#e8e8f0]">{t("CreatorWallet.topUpAmount")}</label>
              <input
                type="number"
                name="amount"
