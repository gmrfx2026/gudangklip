                ...
                <div className="p-5">
                  ...
                  {isJoined ? (
                    <button disabled className="w-full rounded-xl bg-[#10b981]/20 py-2.5 text-sm font-semibold text-[#10b981] flex items-center justify-center gap-2">
                      <Check className="h-4 w-4" /> {t("CreatorExplore.joined")}
                    </button>
                  ) : (
                    <button
                    ...
                    >
                      {joining === campaign.id ? (
                        <span className="flex items-center justify-center gap-2"><Loader2 className="h-4 w-4 animate-spin" /> {t("CreatorExplore.joining")}</span>
                      ) : t("CreatorExplore.joinCampaign")}
                    </button>
                  )}
                </div>
              </div>
