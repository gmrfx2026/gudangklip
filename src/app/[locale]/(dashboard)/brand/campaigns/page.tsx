    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-[#8888aa]">{t("BrandCampaigns.subtitle")}</p>
        </div>
        <Link
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 text-center">
          ...
          <p className="mt-1 text-sm text-[#8888aa]">{t("BrandCampaigns.emptyDesc")}</p>
          <Link
            href="/brand/campaigns/new"
              ...
              <div key={c.id} className="rounded-2xl border border-[#2a2a50] bg-[#111128]/50 p-6">
                <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                  ...
                  <div className="flex gap-6 lg:gap-8">
                    <div className="text-center">
                      ...
                      <div className="text-xs text-[#8888aa]">{t("BrandCampaigns.creators")}</div>
                    </div>
                    <div className="text-center">
                      <div className="flex items-center gap-1 text-lg font-bold text-white">
                        <BarChart3 className="h-4 w-4" /> {totalViewsK}K
                      </div>
                      <div className="text-xs text-[#8888aa]">{t("BrandCampaigns.views")}</div>
                    </div>
                    <div className="text-center">
                      <div className="flex items-center gap-1 text-lg font-bold text-white">
                        <DollarSign className="h-4 w-4" /> {formatCurrency(c.remainingBudget)}
                      </div>
                      <div className="text-xs text-[#8888aa]">{t("BrandCampaigns.remainingBudget")}</div>
                    </div>
                  </div>
                  <div>
                    <Link
                ...
                <div className="mt-4">
                  <div className="mb-1 flex justify-between text-xs">
                    <span className="text-[#8888aa]">{t("BrandCampaigns.budget")}: {formatCurrency(budgetUsed)} / {formatCurrency(c.totalBudget)}</span>
