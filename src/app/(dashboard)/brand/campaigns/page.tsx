    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-[#8888aa]">Kelola semua campaign brand kamu.</p>
        </div>
        <Link
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 text-center">
          <Megaphone className="mb-4 h-12 w-12 text-[#8888aa]" />
          <h3 className="text-lg font-semibold text-white">Belum ada campaign</h3>
          <p className="mt-1 text-sm text-[#8888aa]">Buat campaign pertama kamu untuk mulai mencari creator.</p>
          <Link
            href="/brand/campaigns/new"
              ...
              <div key={c.id} className="rounded-2xl border border-[#2a2a50] bg-[#111128]/50 p-6">
                <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-[#8888aa]">CPM: Rp {c.cpmRate.toLocaleString()}/1K views</p>
                  </div>
                  <div className="flex gap-6 lg:gap-8">
                    <div className="text-center">
                      ...
                      <div className="text-xs text-[#8888aa]">Creators</div>
                    </div>
                    <div className="text-center">
                      <div className="flex items-center gap-1 text-lg font-bold text-white">
                    ...
                    <div className="text-center">
                      ...
                      <div className="text-xs text-[#8888aa]">Sisa Budget</div>
                    </div>
                  </div>
                  <div>
                    <Link
                ...
                <div className="mt-4">
                  <div className="mb-1 flex justify-between text-xs">
                    <span className="text-[#8888aa]">Budget: {formatCurrency(budgetUsed)} / {formatCurrency(c.totalBudget)}</span>
